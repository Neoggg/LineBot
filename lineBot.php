...
if ($messageInfo['type'] == 'location') {
	$pushMessageBuilder = new \LINE\LINEBot\MessageBuilder\TextMessageBuilder($HttpRequestBody .' '. $messageInfo['latitude'] . ' ' . $messageInfo['longitude'] . PHP_EOL . $messageInfo['address'], $QuickReplyMessageBuilder);
